    ...
    <>
      <div className="flex flex-col border-b border-stroke last-of-type:border-none dark:border-strokedark">
        <button
          ...
          className="flex cursor-pointer items-center justify-between px-6 py-5 text-left text-metatitle3 font-medium text-black dark:text-white lg:px-10 lg:py-7.5"
        >
          <div className="mr-5">{quest}</div>
